    ...
    <div style={{ backgroundColor: '#020106', color: 'white', minHeight: '100vh', padding: '24px', fontFamily: 'sans-serif' }}>
      <div style={{ maxWidth: '450px', margin: '0 auto' }}>
        <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '40px' }}>
          <div>
            <h1 style={{ fontSize: '32px', fontWeight: '900', fontStyle: 'italic', margin: 0 }}>
          ...
          <div style={{ background: 'rgba(59, 130, 246, 0.1)', border: '1px solid rgba(59, 130, 246, 0.3)', padding: '12px 20px', borderRadius: '20px' }}>
            <div style={{ fontSize: '20px', fontWeight: '900', color: '#3b82f6' }}>18°</div>
          </div>
        </header>

        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          <h2 style={{ fontSize: '10px', fontWeight: 'bold', opacity: 0.3, letterSpacing: '3px' }}>DAGENS PROTOKOL</h2>
          {appointments.map((apt, i) => (
            <div key={i} style={{ 
              ...
              <div style={{ fontSize: '22px', fontWeight: '900', fontStyle: 'italic' }}>{apt.time}</div>
            </div>
          ))}
        </div>

        <div style={{ marginTop: '40px', padding: '20px', borderRadius: '24px', background: 'rgba(255, 222, 89, 0.1)', border: '1px solid rgba(255, 222, 89, 0.1)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <span style={{ fontSize: '24px', fontWeight: '900', fontStyle: 'italic' }}>6. PLADS</span>
          <div style={{ background: '#ffde59', color: 'black', padding: '10px', borderRadius: '12px', fontWeight: '900' }}>BIF</div>
        </div>
      </div>
    </div>
  );
